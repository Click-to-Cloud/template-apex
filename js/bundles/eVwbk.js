...
var eVwbk = function (_Component) {
  _inherits(eVwbk, _Component);

  function eVwbk() {
    _classCallCheck(this, eVwbk);

    return _possibleConstructorReturn(this, (eVwbk.__proto__ || Object.getPrototypeOf(eVwbk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eVwbk, _methodsSoy2.default);

exports.default = eVwbk;
...
exports.templates = exports.eVwbk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eVwbk.
   * @public
   */

  goog.module('eVwbk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eVwbk.render';
  }
...
_metalSoy2.default.register(eVwbk, templates);
exports.eVwbk = eVwbk;

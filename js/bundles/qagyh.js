...
var qagyh = function (_Component) {
  _inherits(qagyh, _Component);

  function qagyh() {
    _classCallCheck(this, qagyh);

    return _possibleConstructorReturn(this, (qagyh.__proto__ || Object.getPrototypeOf(qagyh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qagyh, _conversionSoy2.default);

exports.default = qagyh;
...
exports.templates = exports.qagyh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qagyh.
   * @public
   */

  goog.module('qagyh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qagyh.render';
  }
...
_metalSoy2.default.register(qagyh, templates);
exports.qagyh = qagyh;

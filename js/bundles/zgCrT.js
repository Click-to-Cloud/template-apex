...
var zgCrT = function (_Component) {
  _inherits(zgCrT, _Component);

  function zgCrT() {
    _classCallCheck(this, zgCrT);

    return _possibleConstructorReturn(this, (zgCrT.__proto__ || Object.getPrototypeOf(zgCrT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(zgCrT, _creationSoy2.default);

exports.default = zgCrT;
...
exports.templates = exports.zgCrT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace zgCrT.
   * @public
   */

  goog.module('zgCrT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'zgCrT.render';
  }
...
_metalSoy2.default.register(zgCrT, templates);
exports.zgCrT = zgCrT;

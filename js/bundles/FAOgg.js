...
var FAOgg = function (_Component) {
  _inherits(FAOgg, _Component);

  function FAOgg() {
    _classCallCheck(this, FAOgg);

    return _possibleConstructorReturn(this, (FAOgg.__proto__ || Object.getPrototypeOf(FAOgg)).apply(this, arguments));
  }
...
_metalSoy2.default.register(FAOgg, _indexSoy2.default);

exports.default = FAOgg;
...
exports.templates = exports.FAOgg = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace FAOgg.
   * @public
   */

  goog.module('FAOgg.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'FAOgg.render';
  }
...
_metalSoy2.default.register(FAOgg, templates);
exports.FAOgg = FAOgg;

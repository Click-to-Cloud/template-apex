...
var SofPA = function (_Component) {
  _inherits(SofPA, _Component);

  function SofPA() {
    _classCallCheck(this, SofPA);

    return _possibleConstructorReturn(this, (SofPA.__proto__ || Object.getPrototypeOf(SofPA)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SofPA, _step_2Soy2.default);

exports.default = SofPA;
...
exports.templates = exports.SofPA = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SofPA.
   * @public
   */

  goog.module('SofPA.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SofPA.render';
  }
...
_metalSoy2.default.register(SofPA, templates);
exports.SofPA = SofPA;

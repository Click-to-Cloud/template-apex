...
var HzWvJ = function (_Component) {
  _inherits(HzWvJ, _Component);

  function HzWvJ() {
    _classCallCheck(this, HzWvJ);

    return _possibleConstructorReturn(this, (HzWvJ.__proto__ || Object.getPrototypeOf(HzWvJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HzWvJ, _indexSoy2.default);

exports.default = HzWvJ;
...
exports.templates = exports.HzWvJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HzWvJ.
   * @public
   */

  goog.module('HzWvJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HzWvJ.render';
  }
...
_metalSoy2.default.register(HzWvJ, templates);
exports.HzWvJ = HzWvJ;

...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('a', null, null, 'href', '/template-apex/tutorials/getting_started/step_1.html', 'class', 'btn btn-accent btn-sm');
    itext('Get Started');
    ie_close('a');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/Template.apex/', 'class', 'btn btn-success btn-sm');
    itext('GitHub');
    ie_close('a');
  ...
  function $why(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Why Template.apex?');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('Sometimes we have the need to provide support for customizable templates like email templates. In these situations, Template.apex can help you evaluate templates written in visualforce expression syntax, which is handy and easy to pick up for those experienced in Salesforce visualforce pages.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $features(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Template.apex offers super easy-to-use API to help you evaluate templates.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Low Learning Curve');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Template.apex uses visualforce expression syntax and it\'s easy for Salesforce developers.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    ...
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Template.apex can be easily customized.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
  ...
  function $how(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('div', null, null, 'class', 'col-md-12 col-md-offset-2');
    ie_open('h3', null, null, 'class', 'about-title');
    itext('Easy Template Engine');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('Pick it up and evalute your templates.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $highlights(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Easy Evaluation');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Template.apex evaluates templates written in visualforce expression syntax.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/template-apex/images/highlight_1.png', 'alt', 'Easy Evaluation', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Template.apex is open to customization.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/template-apex/images/highlight_2.png', 'alt', 'Customization', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_close('div');

...
var eUXOo = function (_Component) {
  _inherits(eUXOo, _Component);

  function eUXOo() {
    _classCallCheck(this, eUXOo);

    return _possibleConstructorReturn(this, (eUXOo.__proto__ || Object.getPrototypeOf(eUXOo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(eUXOo, _step_2Soy2.default);

exports.default = eUXOo;
...
exports.templates = exports.eUXOo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace eUXOo.
   * @public
   */

  goog.module('eUXOo.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param952 = function param952() {
      ie_open('h2');
      ...
      ie_close('p');
      ie_open('p');
      itext('Template.apex uses Func objects from R.apex, and a Func is actually a custom Apex object that mimics the behavior of a function.');
      ie_close('p');
      ie_open('p');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param952 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'eUXOo.render';
  }
...
_metalSoy2.default.register(eUXOo, templates);
exports.eUXOo = eUXOo;

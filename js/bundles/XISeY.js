...
var XISeY = function (_Component) {
  _inherits(XISeY, _Component);

  function XISeY() {
    _classCallCheck(this, XISeY);

    return _possibleConstructorReturn(this, (XISeY.__proto__ || Object.getPrototypeOf(XISeY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XISeY, _indexSoy2.default);

exports.default = XISeY;
...
exports.templates = exports.XISeY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XISeY.
   * @public
   */

  goog.module('XISeY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XISeY.render';
  }
...
_metalSoy2.default.register(XISeY, templates);
exports.XISeY = XISeY;
